...
let EmployeeController = class EmployeeController {
    constructor(createEmployeeUseCase, getEmployeesUseCase, assignPointUseCase, deleteEmployeeUseCase, getPointEmployeesUseCase, unassignPointUseCase, updateEmployeePermissionsUseCase, updateEmployeeDataUseCase) {
        ...
        this.updateEmployeeDataUseCase = updateEmployeeDataUseCase;
    }
    ...
    async updateData(userId, employeeId, dto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Обновить данные сотрудника' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Данные обновлены', type: employee_1.EmployeeResponseDto }),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('employeeId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, employee_1.UpdateEmployeeDataDto]),
    __metadata("design:returntype", Promise)
], EmployeeController.prototype, "updateData", null);
__decorate([
...
exports.EmployeeController = EmployeeController = __decorate([
    ...
    __metadata("design:paramtypes", [employee_2.CreateEmployeeUseCase,
        ...
        employee_2.UpdateEmployeeDataUseCase])
], EmployeeController);
